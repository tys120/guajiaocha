Page({
  ...
  chooseTime(ev){
    ...
    my.navigateTo({url: '/pages/consultation/scheduling/scheduling?userInfo='+JSON.stringify(this.data.userInfo) +'&info='+JSON.stringify(this.data.timeRange[ev.target.dataset.index])+'&ymd='+this.data.chooseDate.date});
  },
  onUnload: function () {
